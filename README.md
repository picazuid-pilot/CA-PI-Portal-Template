...
3. **Upload**, then visit `yoursite.com/register.php`, enter the invite code you set, and create the first account.
...
See [`docs/setup.md`](docs/setup.md) for a more detailed walkthrough (hosting quirks, SMTP setup, storage backends, backups).
...
docs/                    → setup guide, role descriptions, translation notes
```
